...
public class Test2 extends TestBase{
	...
	@Test()
	public void Differentclassmethod() throws InterruptedException, IOException {
		...
		db.getuserid().sendKeys(prop.getProperty("SecondAccUserName"));
		db.getpassword().sendKeys(prop.getProperty("SecondAccPassword"));
